...
if (isset($_POST['submitdata']) && $_POST['submitdata'] == 'Save') {
    ...
    $addcategory = addairport($vCategoryName,$city,$state,$country);
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
								...
								<div class="form-group">
                                    <label>City*</label>                                
                                    <input type="text" class="form-control" id="vCategoryName" name="city" required onkeypress="return spacerestri(event, this);">                                
                                </div>
								<div class="form-group">
                                    <label>State*</label>                                
                                    <input type="text" class="form-control" id="vCategoryName" name="state" required onkeypress="return spacerestri(event, this);">                                
                                </div>
								<div class="form-group">
                                    <label>Country*</label>                                
                                    <input type="text" class="form-control" id="vCategoryName" name="country" required onkeypress="return spacerestri(event, this);">                                
                                </div>
                            </div>
                        </div> 
