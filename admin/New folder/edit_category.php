...
//        chmod($EVENT_IMAGE_THUMB_PATH . $newfilename, 0777);
    ...
    $updatecategory = updateCategory($iCategoryID, $vCategoryName,$newfilename);
    if ($updatecategory) {
        ...
        <div class="row">
            ...
            <form role="form" method="post" id="addevent" name="eventform" enctype="multipart/form-data">
                ...
                if (isset($_REQUEST['cid']) && $_REQUEST['cid'] != '') {
                    $categorydata = getCategoryDataByID($_REQUEST['cid']);
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Name*</label>                                
                                    <input type="text" class="form-control" id="vCategoryName" name="vCategoryName" required value="<?php echo (isset($categorydata['vCategoryName']) && $categorydata['vCategoryName'] != '') ? $categorydata['vCategoryName'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>                              
                                ...
                                <div class="form-group product">
                                    ...
                                    <div class="fileinput fileinput-new col-sm-3 no-padding" data-provides="fileinput">
                                        <div class="imgdisplay">
                                            <?php if ($categorydata['tImage'] != '') { ?>
                                                <img src="<?php echo "../" . $CATEGORY_IMAGE_URL . $categorydata['tImage']; ?>" id="tImage" height='150' width='150'>
                                            <?php } else { ?>
                                        ...
                                        <div>
                                            <?php if ($categorydata['tImage'] != '') { ?>
                                                <span class="btn btn-danger btn-file userpic">
                                                    ...
                                                    <input type="file" name="tImage"  title="Select Image" class="productimg" id="tImage1" data-img="<?php echo $categorydata['iCategoryID']; ?>" >
                                                </span>                                            
                                            <?php } else { ?>
                                                <span class="btn btn-danger btn-file userpic">
