                            ...
                            <tbody>
                                ...
                                if (!empty($category_data)) {
                                    foreach ($category_data as $val) {
                                        ...
                                        echo (isset($val['tImage']) && $val['tImage'] != '') ? '../' . $CATEGORY_IMAGE_URL . $val['tImage'] : '../images/default.gif';
                                        echo "> </td>";
                                        echo "<td><a href='edit_category.php?cid=".$val['iCategoryID']."' role='button' class='btn btn btn-primary editcategory' data-toggle='modal'>Edit</a>&nbsp;&nbsp;<a href='#deletemodal' id='deletecategory" . $val['iCategoryID'] . "' iCategoryID='" . $val['iCategoryID'] . "' role='button' class='deletecategory btn btn btn-danger' data-toggle='modal'>Remove</a> </td>";
                                        echo "</tr>";
                                    }
                                }
                                ?>
